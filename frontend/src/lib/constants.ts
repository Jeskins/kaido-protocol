    ...
    Faucet: {
      abi: [
        ...
        },
        {
          ...
          inputs: [],
          outputs: [
            { name: "", type: "address", internalType: "contract IKintoID" },
          ],
          stateMutability: "view",
        },
        {
    ...
    KintoID: {
      abi: [
        ...
        },
        {
          ...
          name: "monitor",
          inputs: [
            { name: "_accounts", type: "address[]", internalType: "address[]" },
            {
      ...
      abi: [
          ...
          outputs: [
            {
              ...
              components: [
                { name: "tokenId", type: "uint256", internalType: "uint256" },
                { name: "dsaEnabled", type: "bool", internalType: "bool" },
                {
        ...
        },
        {
          ...
          inputs: [
            ...
            { name: "devEOAs", type: "address[]", internalType: "address[]" },
          ],
          outputs: [],
          stateMutability: "nonpayable",
        },
        ...
        { type: "error", name: "KYCRequired", inputs: [] },
        {
          ...
          inputs: [
            ...
            { name: "flagsLength", type: "uint256", internalType: "uint256" },
          ],
        },
        {
          type: "error",
    ...
    BundleBulker: {
      abi: [
        ...
        },
        {
          ...
          outputs: [
            { name: "", type: "address", internalType: "contract IInflator" },
          ],
          stateMutability: "view",
        },
        {
        ...
        },
        {
          ...
          inputs: [
            { name: "inflatorId", type: "uint32", internalType: "uint32" },
            {
              name: "inflator",
              type: "address",
      ...
      abi: [
        {
          ...
          inputs: [
            ...
            { name: "startTime_", type: "uint256", internalType: "uint256" },
          ],
          stateMutability: "nonpayable",
        },
        {
        ...
        },
        {
          ...
          inputs: [
            ...
            { name: "bonusAmount_", type: "uint256", internalType: "uint256" },
          ],
          outputs: [],
          stateMutability: "nonpayable",
        },
      ...
      abi: [
        ...
        },
        {
          ...
          outputs: [
            ...
            { name: "ethCostCount", type: "uint256", internalType: "uint256" },
          ],
          stateMutability: "view",
        },
        {
        ...
        },
        {
          ...
          outputs: [
            { name: "amount", type: "uint256", internalType: "uint256" },
            { name: "_unlockBlock", type: "uint256", internalType: "uint256" },
          ],
          stateMutability: "view",
        },
        {
        ...
        },
        {
          ...
          name: "setAppRegistry",
          inputs: [
            { name: "_newRegistry", type: "address", internalType: "address" },
          ],
          outputs: [],
          stateMutability: "nonpayable",
        },
        ...
        { type: "error", name: "OnlyOwner", inputs: [] },
        { type: "error", name: "PaymasterAndDataLengthInvalid", inputs: [] },
      ...
      abi: [
        {
          ...
          inputs: [
            ...
            { name: "msgGasLimit_", type: "uint256", internalType: "uint256" },
            { name: "connector_", type: "address", internalType: "address" },
            { name: "execPayload_", type: "bytes", internalType: "bytes" },
        ...
        },
        {
          ...
          inputs: [
            { name: "connector_", type: "address", internalType: "address" },
            { name: "msgGasLimit_", type: "uint256", internalType: "uint256" },
            { name: "payloadSize_", type: "uint256", internalType: "uint256" },
          ],
          outputs: [
        ...
        },
        {
          ...
          inputs: [
            { name: "connector_", type: "address", internalType: "address" },
            { name: "messageId_", type: "bytes32", internalType: "bytes32" },
          ],
          outputs: [],
          stateMutability: "nonpayable",
        },
    ...
    IHook: {
      abi: [
          ...
          inputs: [
            {
              ...
              components: [
                ...
                { name: "postHookData", type: "bytes", internalType: "bytes" },
                {
                  name: "transferInfo",
                  type: "tuple",
        ...
        },
        {
          ...
          outputs: [
            { name: "postRetryHookData", type: "bytes", internalType: "bytes" },
            {
              name: "transferInfo",
              type: "tuple",
              internalType: "struct TransferInfo",
        ...
        },
        {
          ...
          outputs: [
            ...
            { name: "postSrcHookData", type: "bytes", internalType: "bytes" },
          ],
          stateMutability: "nonpayable",
        },
      ],
      ...
      abi: [
        ...
        },
        {
          ...
          inputs: [
            ...
            { name: "siblingPlug_", type: "address", internalType: "address" },
            {
          ...
          inputs: [
            {
              ...
              components: [
                { name: "packetId", type: "bytes32", internalType: "bytes32" },
                {
                  name: "proposalCount",
                  type: "uint256",
                  internalType: "uint256",
        ...
        },
        {
          ...
          name: "getPlugConfig",
          inputs: [
            { name: "plugAddress_", type: "address", internalType: "address" },
            {
              name: "siblingChainSlug_",
              type: "uint32",
              internalType: "uint32",
          ...
          outputs: [
            { name: "siblingPlug", type: "address", internalType: "address" },
            {
            ...
            { name: "capacitor__", type: "address", internalType: "address" },
            { name: "decapacitor__", type: "address", internalType: "address" },
          ],
          stateMutability: "view",
        },
        {
    ...
    EngenCredits: {
      abi: [
        ...
        },
        {
          ...
          name: "setCredits",
          inputs: [
            { name: "_wallets", type: "address[]", internalType: "address[]" },
        ...
        },
        {
          ...
          inputs: [
            { name: "_transfersEnabled", type: "bool", internalType: "bool" },
          ],
          outputs: [],
          stateMutability: "nonpayable",
        },
      ...
      abi: [
        {
          ...
          inputs: [
            ...
            { name: "_engenCredits", type: "address", internalType: "address" },
            {
          ...
          outputs: [
            {
              ...
              components: [
                ...
                { name: "claimedFaucet", type: "bool", internalType: "bool" },
      ...
      abi: [
        {
          ...
          inputs: [
            ...
            { name: "_appRegistry", type: "address", internalType: "address" },
          ],
          stateMutability: "nonpayable",
        },
        {
    ...
    KintoWallet: {
      abi: [
        ...
        },
        {
          ...
          inputs: [
            { name: "newRecoverer", type: "address", internalType: "address" },
          ],
          outputs: [],
          stateMutability: "nonpayable",
        },
        ...
        },
        {
          ...
          inputs: [
            { name: "newPolicy", type: "uint256", internalType: "uint256" },
        ...
        },
        {
          ...
          inputs: [
            ...
            { name: "_recoverer", type: "address", internalType: "address" },
          ],
          outputs: [],
          stateMutability: "nonpayable",
        },
        ...
        { type: "error", name: "InvalidApp", inputs: [] },
        {
          ...
          name: "InvalidDevMode",
          inputs: [
            { name: "newDevMode", type: "uint256", internalType: "uint256" },
          ],
        },
        {
          type: "error",
        ...
        },
        {
          ...
          inputs: [
            { name: "newPolicy", type: "uint8", internalType: "uint8" },
            { name: "newSigners", type: "uint256", internalType: "uint256" },
          ],
        },
      ...
      abi: [
        ...
        },
        {
          ...
          inputs: [
            ...
            { name: "_newRecoverer", type: "address", internalType: "address" },
          ],
          outputs: [],
          stateMutability: "nonpayable",
        },
        ...
        },
        {
          ...
          inputs: [
            { name: "owner", type: "address", internalType: "address" },
            { name: "recoverer", type: "address", internalType: "address" },
            { name: "salt", type: "bytes32", internalType: "bytes32" },
          ],
          outputs: [
            {
